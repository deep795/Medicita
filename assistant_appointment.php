                                ...
                                <tr>
                                    ...
                                    <div class="dropdown ml-auto text-center">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">    
                                            ...
                                            <a class="dropdown-item cursor-pointer" onClick="acceptRejectDoctor('Resheduled','<?= $r['appointment_id'] ?>')">Reshedule Appointment</a>
               ...
               if (data){
                   if( status == "Canceled")
                   {
                     toastr.error("Appointment Canceled", "", {
                        ...
                        setTimeout(function(){ 
                            window.location.href = "assistant_appointment.php";
                        }, 1000);
                   }
                   else if( status == "Resheduled")
                   {
                     toastr.info("Appointment Resheduled", "", {
                        timeOut: 2000,
                        closeButton: !0,
                        debug: !1,
                        newestOnTop: !0,
