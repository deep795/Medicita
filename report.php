...
<button type="button" style="margin-bottom: 5px; margin-left: 84%;" class="btn btn-rounded btn-primary add-modal" data-target="#addModal" data-toggle="modal">
    ...
    <div>
        <?php if(!empty($arr_appointment)) { ?>
            <?php foreach($arr_appointment as $r) { ?>
                <?php if ($r['is_patient_share'] == '0') 
                {?>
                    <div class="d-flex justify-content-start mb-4">
                        <div class="img_cont_msg">
                        <?php
                        $sql1 = "select * from user where id = '".$r['doc_id']."'";
            ...
            <div style="margin-left:31%;" class="row h-100 align-items-center">
                <div class="col-md-5">
                    <div class="form-input-content text-center error-page">
                        ...
                        <p>Click the "Add Report" button to add new report.</p>
						<div>
                            <a class="btn btn-primary" onclick="history.go(-1);return false;">Back</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $.ajax({
        ...
        success: function(data)
        {
            ...
            $('#addModal').hide();
                ...
                setTimeout(function(){ 
                window.location.href = "report.php?appointment_id="+appointment_id;
                }, 1000);
            }
            else
            {
