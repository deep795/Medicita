...
$sql1 = "insert into report(patient_id, appointment_id, report_description, doc_id, is_patient_share) values ('".$_POST['patient_id']."', '".$_POST['appointment_id']."', '".$_POST['report_description']."', '".$_POST['doc_id']."', '1')";
